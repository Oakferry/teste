<%-- 
    Document   : painelAdm
    Created on : 4 de nov. de 2024, 15:00:34
    Author     : caio.9181
--%>
    ...
    <main>
            ...
            <nav class="navbar bg-body-primary ps-4 pt-4 ">
              <div class="container-fluid d-flex justify-content-center w-50">
                <form class="d-flex w-50 mx-auto" role="search" method="post">
        ...
        <table class="table table-bordered mt-5 w-75 mx-auto">
            ...
            <%  
                ...
                while (rs.next()){
                  ...
                  out.print("<tr>");
                    ...
                    out.print("<td> <a class='d-flex justify-content-center' href='excluirUsuario.jsp?id=" + rs.getString(1) + "'><img src='img/lata-de-lixo.png' alt='alt'/> </td>");
                    out.print("<td> <a class='d-flex justify-content-center' href='alterarUsuario.jsp?id=" + rs.getString(1) + "'><img src='img/caneta.png' alt='alt'alt'/>  </td>");
                  out.print("<tr>");
         ...
         <div class="d-flex justify-content-center adicionar pt-4">
            <a href="adicionarUsuario.jsp" class="btn btn-primary">Adicionar usuário</a>
        </div>
